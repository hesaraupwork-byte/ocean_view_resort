// src/pages/admin/AdminBills.jsx
...
function BillingModal({ reservation, onClose, onSaved, onError }) {
  ...
  function validate() {
    ...
    // optional rates — if user filled, validate >=0
  ...
  async function saveBilling() {
    ...
    try {
      ...
      // ✅ PATCH /api/reservations/{reservationNo}/billing
      const body = {
      ...
      // include optional rates ONLY if provided
    ...
    <>
      <div className="ov-modal-backdrop" onMouseDown={onBackdropClick}>
        <div className="ov-modal" onMouseDown={(e) => e.stopPropagation()}>
          ...
          {/* show existing totals if billing exists */}
          {billing && (
...
export default function AdminBills() {
  ...
  const [billFilter, setBillFilter] = useState("ALL"); // ALL/WITH/WITHOUT
